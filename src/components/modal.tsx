  ...
  return ReactDom.createPortal(
    ...
    >
      <div
        ...
        className="relative flex w-4/5 h-4/5 group-data-[visible=true]:opacity-100 group-data-[visible=true]:visible group-data-[visible=false]:opacity-0 group-data-[visible=false]:invisible flex-col items-center justify-center rounded-base border-2 border-black bg-main p-10 pt-12 font-base shadow-base transition-all duration-300"
      >
